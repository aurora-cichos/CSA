public class Song {
     ...
     */
    public Song(String title, int streams, int songLength, boolean isFavorited) {
        // initialize instance variables
        this.title = title;
    ...
    public String toString() {
        ...
        return "Song { " + "Title: " + title + ", Streams: " + streams + ", Song Length: " + songLength + " seconds" + ", Favorited: " + isFavorited + " }";
    }
}
